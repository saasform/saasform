...
var _countUp = require("../utils/countUp");

function initPricing() {
  window.pricingUpdate = function (self, price, decimals) {
    var countUp = new _countUp.CountUp(self.id, price, {
      startVal: self.innerHTML,
...
},{"../utils/countUp":8}],7:[function(require,module,exports){
"use strict";
...
document.onreadystatechange = function () {
  if (document.readyState === 'complete') {
    ...
    (0, _utils.initModals)();
    (0, _pricing.initPricing)();
  }
};

},{"./libs/components/backtotop":4,"./libs/components/navbar":5,"./libs/components/pricing":6,"./libs/components/sidebar":7,"./libs/utils/utils":9,"./store/store":11,"alpinejs":2,"feather-icons":3}],11:[function(require,module,exports){
"use strict";
